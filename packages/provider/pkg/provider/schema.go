...
import (
    ...
    vp "github.com/mikecbrant/verified-permissions-authorizer/packages/provider/pkg/awssdk/verifiedpermissions"
...
// Local helpers for schema parsing/enforcement were replaced with shared/internal common package functions.
